defmodule ElixirRestApiWeb.CommentControllerTest do
  use ElixirRestApiWeb.ConnCase

  alias ElixirRestApi.Content
  alias ElixirRestApi.Content.Comment

  @create_attrs %{
    comment_content: "some comment_content",
    name: "some name"
  }
  @update_attrs %{
    comment_content: "some updated comment_content",
